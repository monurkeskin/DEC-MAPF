...
| [02_custom_negotiation_agent.py](02_custom_negotiation_agent.py) | Historical subclass sketch | Initializes an object only; not a registered, executed or TAOP-v2-qualified policy |
...
## Large GUI illustrations

[Gallery instructions](../docs/GALLERY.md#recreate-the-gallery) generate and execute synthetic 32×32/80-agent and 64×64/100-agent examples, then capture the actual GUI. Run data stay under ignored `runs/`; the repository stores reviewed screenshots and compact provenance.
