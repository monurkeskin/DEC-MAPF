"""Check solver discovery, scenario validation and supervised HTTP execution."""
...
def test_solver_registry_capabilities():
    """Expose registered solvers with their supported parameters."""
...
def test_scenario_service_validation():
    """Reject blocked endpoints and individually disconnected goals."""
    # Valid instance
...
def test_api_job_lifecycle_and_persistence(client):
    """Submit a job, wait for completion and read its validated saved result."""
...
def test_api_job_sse_stream(client):
    """Verify GET /api/v1/jobs/{job_id}/stream."""
