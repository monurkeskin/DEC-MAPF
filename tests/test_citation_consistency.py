"""Check publication identities and software versions across citation metadata."""
...
EXPECTED_SOFTWARE_VERSION = "0.1.0a2"
...
def test_citation_cff_consistency() -> None:
    ...
    for author in EXPECTED_AUTHORS:
        assert (
            author in content or author.replace("ü", "u").replace("ğ", "g") in content
        )
