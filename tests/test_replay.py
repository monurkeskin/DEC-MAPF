"""Check recorded-state reconstruction and deterministic seeking."""
...
def test_replay_engine_basic_advancement() -> None:
    ...
    events = [
        ManifestEvent(
            "git123", 42, 10, 10, 2, "SETTING_4", "SC", 5, 0, 100.0
        ).to_dict(),
        KeyframeEvent(
            0,
            {
...
def test_replay_matches_live_simulation() -> None:
    """State hash obtained by replaying matches live run's state hash."""
