...
def test_documentation_stage_retains_animated_assets(tmp_path, monkeypatch):
    ...
    for name in ("README.md", "CONTRIBUTING.md", "REPRODUCIBILITY.md", "CHANGELOG.md", "CITATION.cff", "reference.bib", "LICENSE", "THIRD_PARTY_NOTICES.md", "pyproject.toml", "uv.lock", "codemeta.json", ".zenodo.json", "frontend/package-lock.json", "frontend/README.md", "mkdocs.yml", "benchmarks/README.md"):
