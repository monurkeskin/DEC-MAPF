...
def test_world_simulation_two_crossing_agents():
    ...
    # Cross intersection at (3, 3) at t=3!
...
def test_batch_evaluation():
    mock_runs = [
        {"scenario_id": "s1", "success": True, "total_steps": 12, "negotiation_count": 2, "total_path_length": 24},
        {"scenario_id": "s2", "success": True, "total_steps": 14, "negotiation_count": 3, "total_path_length": 28},
        {"scenario_id": "s3", "success": False, "total_steps": 50, "negotiation_count": 5, "total_path_length": 40},
    ]
