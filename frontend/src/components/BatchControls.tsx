...
export function BatchControls({
  ...
  return (
    <>
      ...
      <p className="muted">
        Historical JAAMAS subsample execution requires its exact selection
        manifest; these profiles only test the modern implementation.
      </p>
      <p>
        Up to 32 local jobs. Preview every expanded input before admission. No
        historical full experiment is launched automatically.
      </p>
      <button
        onClick={() =>
          setBatchText(
