...
No remote fonts, authentication SDKs, analytics or paid API are required by the workspace. Unused template graphics are excluded from the final bundle. UI diagrams, styles and Canvas graphics are code-native.
