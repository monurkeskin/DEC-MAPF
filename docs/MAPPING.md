...
|---|---|---|
| Acknowledgements and payment | Section 4, Fig.2; Java Action and NegotiationSession | `negotiation/ledger.py`, `taop.py`; repeated-any-own-offer, funds, positive payment and atomic rollback witnesses |
