...
| --- | --- | --- |
| `src/mapf/core/` | Grid, paths, settings, file inputs, synthetic sampling and independent validator | Reason about discrete problem semantics |
| `src/mapf/engine/` | World state and the ordered perception/negotiation/movement pipeline | Trace a complete simulation tick |
