...
Start with a small change whose intended behavior and checks can be inspected together. These are contribution entry points, not open modernization blockers or automatically posted issues.
