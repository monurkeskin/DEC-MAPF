...
Clone using your normal repository credentials:
...
python -m pip install ./dec_mapf-0.1.0a1-py3-none-any.whl
mapf doctor
# Add the GUI and analysis dependencies to the same wheel:
python -m pip install './dec_mapf-0.1.0a1-py3-none-any.whl[gui,analysis]'
