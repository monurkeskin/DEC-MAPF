...
This is [DEC-MAPF, alpha research software](ALPHA-STATUS.md), with Python package version `0.1.0a1`. The finite compatibility checks below describe current behavior, not a stable-release guarantee.
