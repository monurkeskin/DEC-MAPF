...
The public documentation describes a single initial alpha baseline. Export checks reject internal development chronology and private commit literals; content hashes identify the distributed files.
