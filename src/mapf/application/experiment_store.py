...
class ExperimentStore(Protocol):
    """Persistence operations for frozen manifests, attempts and elapsed budget.

    Implementations retain attempt history and return fresh decoded records.
    Execution policy depends on this contract rather than issuing SQL itself.
    """
