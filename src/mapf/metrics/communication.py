...
class CommunicationLedger:
    """Accumulate delivered message receipts and transfer volume for one run.

    Recording level does not control this ledger. Spatial disclosures collapse
    repeated cells; message, byte and transfer counts retain actual deliveries.
    """
