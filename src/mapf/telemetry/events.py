"""Discrete Telemetry Event Schema for Multi-Agent Pathfinding Simulations.

High-throughput, slot-optimized immutable dataclasses representing fine-grained
discrete simulation events: provenance manifests, periodic keyframes, agent movements,
bilateral negotiation sessions, individual bidding rounds, and spatial broadcasts.
"""
...
class DiagnosticEvent:
    event_type: Literal["TOKEN_TRANSFER", "SAFETY", "OBSERVATION", "MOVEMENT_REPAIR", "REPLAN", "REACHED_STATE", "NEGOTIATION_STOP", "DECISION_HEAT"]
    tick: int
...
class ManifestEvent:
    """Emitted once at simulation start capturing the full environment provenance."""
...
@dataclass(slots=True, frozen=True)
class KeyframeEvent:
    """Periodic full-state snapshot allowing instant seeking and fault recovery."""
...
class BroadcastEvent:
    """Emitted when an agent broadcasts its spatial presence or heat map within FoV."""
